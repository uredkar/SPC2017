...
import {OnInit, OnDestroy, Directive, Output, EventEmitter, ElementRef, Input} from '@angular/core';
...
export class HotTable implements OnInit, OnDestroy{
  ...
  @Input('col-headers') colHeaders:Array<string>;
  @Input('columns') columns:Array<any>;
  @Input('colWidths') colWidths:Array<number>;
